...
public class PesquisaFuncionario extends javax.swing.JFrame {
    ...
    public void preencherTabela(String SQL) {
        ...
        String[] colunas = new String[]{"N° Regist", "Nome Completo", "Cpf", "Rg", "Data Nasc", "Salario", "Usuario", "Senha", "Cargo", "Cep", "Endereço", "Numero", "Bairro", "Complemento", "Cidade", "Estado", "Data Regist", "Resgistro"};
        ...
        try {
            ...
            do {
                dados.add(new Object[]{connBanco.rs.getInt("id"), connBanco.rs.getString("nome"), connBanco.rs.getString("cpf"), connBanco.rs.getInt("rg"), formatter.format(connBanco.rs.getDate("datanasc")), connBanco.rs.getString("salario"), connBanco.rs.getString("nomeUsuario"), connBanco.rs.getString("senha"), connBanco.rs.getString("cargo"),
                    connBanco.rs.getInt("cep"), connBanco.rs.getString("rua"), connBanco.rs.getInt("numero"), connBanco.rs.getString("bairro"), connBanco.rs.getString("complemento"), connBanco.rs.getString("cidade"), connBanco.rs.getString("estado"), formatter.format(connBanco.rs.getDate("dataRegistro")), connBanco.rs.getString("cnpj_Transp")});
